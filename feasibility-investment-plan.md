...
```mermaid
graph TB
    REVENUE[Total Revenue<br/>Year 1: $15K-30K]

    REVENUE --> STREAM1[Stream 1: Freemium B2B<br/>Month 4+]
    REVENUE --> STREAM2[Stream 2: Job Ads<br/>Month 6+]
    REVENUE --> STREAM3[Stream 3: Premium Features<br/>Month 9+]
    REVENUE --> STREAM4[Stream 4: Grants/Partnerships<br/>Ongoing]

    STREAM1 --> R1[B2B SaaS<br/>$10-50/month<br/>Primary Revenue]
    STREAM2 --> R2[Sponsored Jobs<br/>$5-20/post<br/>Supplement]
    STREAM3 --> R3[Featured Profiles<br/>$2-5/month<br/>Job Seekers]
    STREAM4 --> R4[NGO Grants<br/>$5K-15K<br/>Initial Support]

    style REVENUE fill:#F8B400
    style STREAM1 fill:#82E0AA
    style STREAM4 fill:#AED6F1
```
...
```mermaid
graph LR
    M0[MVP Launch<br/>Feb 2026<br/>0 users] --> M3[Month 3<br/>100-300 users]
    M3 --> M6[Month 6<br/>500-1,000 users]
    M6 --> M12[Month 12<br/>2,000-5,000 users]
    M12 --> M24[Month 24<br/>10,000-25,000 users]

    M0 -.->|Slow start| M3
    M3 -.->|Word of mouth| M6
    M6 -.->|Organic growth| M12
    M12 -.->|Scaling| M24

    style M0 fill:#F5B7B1
    style M3 fill:#F8B400
    style M6 fill:#82E0AA
    style M12 fill:#AED6F1
    style M24 fill:#D7BDE2
```
...
```mermaid
graph TB
    subgraph "Technology vs. Market Coverage"
        A[job.sy<br/>Outdated Tech, Syrian Only]
        B[forsa.sy<br/>Basic Tech, Syrian Only]
        C[Facebook<br/>Unstructured, High Reach]
        D[Our Platform<br/>AI-Powered, Modern, Syria+Diaspora]
    end
...
```mermaid
graph TB
    FUNDS[$40K-60K Funding]

    FUNDS --> PROD[Product Development<br/>50% = $20K-30K]
    FUNDS --> OPS[Operations/Salaries<br/>25% = $10K-15K]
    FUNDS --> MARKET[Marketing<br/>15% = $6K-9K]
    FUNDS --> BUFFER[Contingency<br/>10% = $4K-6K]

    PROD --> P1[Development<br/>$15K-20K]
    PROD --> P2[Infrastructure<br/>$3K-6K]
    PROD --> P3[Design/Tools<br/>$2K-4K]

    OPS --> O1[Part-time Support<br/>$6K-10K]
    OPS --> O2[Operations<br/>$4K-5K]

    MARKET --> M1[Social Media Ads<br/>$3K-5K]
    MARKET --> M2[Partnerships<br/>$2K-3K]
    MARKET --> M3[Content Creation<br/>$1K-1K]

    style FUNDS fill:#F8B400
    style PROD fill:#82E0AA
    style OPS fill:#AED6F1
